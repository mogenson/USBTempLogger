...
static const ROMPTR struct {uint8_t bLength;uint8_t bDescriptorType; uint16_t chars[13]; } vendor_string = {
	...
	DESC_STRING,
        {'M','i','k','e',' ','M','o','g','e','n','s','o','n'}
};

static const ROMPTR struct {uint8_t bLength;uint8_t bDescriptorType; uint16_t chars[23]; } product_string = {
	sizeof(product_string),
	DESC_STRING,
	{'U','S','B',' ','T','e','m','p','e','r','a','t','u','r','e',' ','M','o','n','i','t','o','r'}
};
...
static const ROMPTR struct {uint8_t bLength;uint8_t bDescriptorType; uint16_t chars[17]; } serial_number = {
	sizeof(serial_number),
	DESC_STRING,
        {'S','e','r','i','a','l',' ','N','u','m','b','e','r',' ','N','/','A'}
};
